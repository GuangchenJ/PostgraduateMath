...
\section{一元函数微分学}
\input{zhenti/gaoshu/yiyuanhanshuweifenxue.tex}
\vspace{2em}

\section{一元函数积分学}
\input{zhenti/gaoshu/yiyuanhanshujifenxue.tex}

\section{常微分方程}

\input{zhenti/gaoshu/ODE.tex}

\section{多元函数微分学}

\input{zhenti/gaoshu/duoyuanhanshuweifenxue.tex}

\section{多元函数积分学}

\input{zhenti/gaoshu/duoyuanhanshujifenxue.tex}

\section{无穷级数}

\input{zhenti/gaoshu/wuqiongjishu.tex}
...
\section{随机事件和概率}
\input{zhenti/gailv/suijshijianhegailv.tex}
\vspace{2em}

\section{随机变量及其分布}
\input{zhenti/gailv/suijibianliangjiqifenbu.tex}
\vspace{2em}

\section{多维随机变量及其分布}
\input{zhenti/gailv/duoweisuijibianliangjiqifenbu.tex}
\vspace{2em}

\section{随机变量的数字特征}
\input{zhenti/gailv/suijibianliangdeshuzitezheng.tex}
\vspace{2em}

\section{大数定律与中心极限定理}
\input{zhenti/gailv/dashudinglvhezhongxinjixiandingli.tex}
\vspace{0em}

\section{数理统计的基本概念}
\input{zhenti/gailv/shulitongjidejibengainian.tex}
\vspace{2em}

\section{参数估计}
\input{zhenti/gailv/canshuguji.tex}
