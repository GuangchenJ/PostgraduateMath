...
\chapter*{高数二错+线代三错+概率三错（乱序版）}

\input{zonghecuoti/1128/all_shuffled_problems.tex}

\chapter{无穷级数}

\input{zonghecuoti/1128/WuQiongJiShu.tex}

\chapter{数列极限}

\input{zonghecuoti/1128/ShuLieJiXian.tex}
